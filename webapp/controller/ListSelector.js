sap.ui.define([
	...
	return BaseObject.extend("enap.f2.ZHR_SOL_VAC.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias enap.f2.ZHR_SOL_VAC.model.ListSelector
		 */
		 ...
		 * @return {enap.f2.ZHR_SOL_VAC.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
