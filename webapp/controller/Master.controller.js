...
sap.ui.define([
	...
	"sap/m/MessageBox",
	"enap/f2/ZHR_SOL_VAC/model/grouper",
	...
	return BaseController.extend("enap.f2.ZHR_SOL_VAC.controller.Master", {
		...
		onSearch: function (oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter("Begda", FilterOperator.Contains, sQuery)];
			} else {
		...
		onOpenViewSettings: function () {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("enap.f2.ZHR_SOL_VAC.view.ViewSettingsDialog", this);
		...
		onConfirmViewSettingsDialog: function (oEvent) {
			...
			aFilterItems.forEach(function (oItem) {
				switch (oItem.getKey()) {
				case "Filter1":
					aFilters.push(new Filter("FleCo", FilterOperator.LE, 100));
					break;
				case "Filter2":
					aFilters.push(new Filter("FleCo", FilterOperator.GT, 100));
					break;
				default:
					break;
				}
				...
				function (mParams) {
					...
					if (!mParams.list.getSelectedItem()) {
						this.getRouter().navTo("object", {
							Idnum: encodeURIComponent(mParams.firstListitem.getBindingContext().getProperty("Idnum"))
						}, true);
					}
				}.bind(this),
				function (mParams) {
		...
		_showDetail: function (oItem) {
			...
			this.getRouter().navTo("object", {
				Idnum: encodeURIComponent(oItem.getBindingContext().getProperty("Idnum"))
			}, bReplace);
		},
