sap.ui.define([
	...
	return UI5Object.extend("enap.f2.ZHR_SOL_VAC.controller.ErrorHandler", {
		 ...
		 * @public
		 * @alias enap.f2.ZHR_SOL_VAC.controller.ErrorHandler
		 */
		...
		_showServiceError: function (sDetails) {
			...
			var sTextError = oError.error.message.value;
			MessageBox.error(
				// this._sErrorText, {
				sTextError, {
